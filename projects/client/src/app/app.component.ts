...
export class AppComponent {
  ...
  ngOnInit(): void {
    ...
    setTimeout(() => {
      this.sendDataToResumeCrafter(this.resumeData);
    }, 5000);
  }

  sendDataToResumeCrafter(resumeData: ResumeData): void {
    this.resumeCrafterWindow?.postMessage(resumeData, 'http://localhost:4200/');
  }
}
